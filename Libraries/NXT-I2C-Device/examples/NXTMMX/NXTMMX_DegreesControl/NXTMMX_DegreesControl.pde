...
setup()
{
    ...
    int             degrees = 90;   // Define variable degrees and set
                                    // equal to 90
    char            str[40];

    // Drive motor 1 forward and backward for a specific number of degrees
    delay(1000);
    sprintf(str, "Motor 1 Forward %d Degrees", degrees);
    Serial.println(str);
    str[0] = '\0';
    ...
    delay(1000);
    sprintf(str, "Motor 1 Reverse %d Degrees", degrees);
    Serial.println(str);
    str[0] = '\0';
    mmx.runDegrees(MMX_Motor_1, 
    ...
    // Drive motor 2 forward and backward for a specific number of degrees
    delay(1000);
    sprintf(str, "Motor 2 Forward %d Degrees", degrees);
    Serial.println(str);
    str[0] = '\0';
    mmx.runDegrees(MMX_Motor_2, 
                   ...
                   MMX_Next_Action_BrakeHold);
    delay(1000);
    sprintf(str, "Motor 2 Reverse %d Degrees", degrees);
    Serial.println(str);
    str[0] = '\0';
    mmx.runDegrees(MMX_Motor_2, 
                   MMX_Direction_Reverse, 
    ...
    // degrees
    delay(1000);
    sprintf(str, "Both Motors Forward %d Degrees", degrees);
    Serial.println(str);
    str[0] = '\0';
    mmx.runDegrees(MMX_Motor_Both, 
                   ...
                   MMX_Next_Action_BrakeHold);
    delay(1000);
    sprintf(str, "Both Motors Reverse %d Degrees", degrees);
    Serial.println(str);
    str[0] = '\0';
    mmx.runDegrees(MMX_Motor_Both, 
                   MMX_Direction_Reverse, 
